...
def liefere_fehlerliste(liste):
    ...
    """"""rueckgabe_liste_sortiert = list(set(rueckgabe_liste))
    rueckgabe_liste_sortiert.sort()""""""
    return rueckgabe_liste
...
if __name__ == '__main__':
    ...
    #responseid = "6909" #finde_responseid(qlog_importe_liste[0])

    liste_responseid = erstelle_liste_aller_responseid(qlog_importe_liste)

    # liste_zeilen_einer_responseid = find_alle_zeilen_einer_responseid(responseid, qlog_importe_liste)
